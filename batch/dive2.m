...
%%%%% USER INPUTS
ocean_depth = 6100;               % approximate ocean depth known before deployment (m) 
...
total_bottom_time = 800*60 + burnwire_time;     % seconds lander is programmed to sit on the bottom
