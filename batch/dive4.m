...
total_bottom_time = 5*60 + burnwire_time;     % seconds lander is programmed to sit on the bottom
...
fn_topside = '20180918_104029.mat'; % topside .mat filename (smaller file)
fn_lander = '20180918_103942.mat'; % lander .mat filename (bigger file)
