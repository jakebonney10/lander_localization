...
total_bottom_time = 240*60 + burnwire_time;     % seconds lander is programmed to sit on the bottom
...
use_lost_lander = [0 1000];     
% Set to 1 if running lost lander problem and change radius (m)
